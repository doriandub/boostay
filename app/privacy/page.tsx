  ...
  return (
    <div className="bg-white min-h-screen w-full text-gray-900 font-sans flex flex-col">
      ...
      <main className="flex-1 max-w-2xl mx-auto px-4 py-12 sm:py-16 lg:py-20">
        <h1 className="text-2xl sm:text-3xl font-bold mb-2 text-gray-900">Privacy Policy</h1>
        <div className="text-sm text-gray-500 mb-8">Last updated: June 2024</div>
        <div className="prose prose-gray max-w-none text-gray-700">
          <p>Boostay ("we", "us", or "our") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our website and services.</p>
